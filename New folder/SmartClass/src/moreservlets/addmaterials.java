	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException 
	{
		...
		try {
			...
			for(FileItem item:multi) {		
				...
				path = "../StudyMaterials/Documents/"+ item.getName();
				...
				item.write(new File("C:/Users/krypto kevin/eclipse-workspace/6th sem project/SmartClass/WebContent/StudyMaterials/Documents/" + item.getName()));
